...
def extract_data(file_path, keywords):
    try:
        ...
        filtered_df = df[df["a1"].astype(str).str.contains('|'.join(keywords), case=False, regex=True)]
        return filtered_df
...
if __name__ == "__main__":
    ...
    load_data_to_mysql(extracted_data, db_host, db_user, db_password, db_name, table_name, auth_plugin)
